...
Specify input dataset path in [Anti-Diabetics-inputs.yml](Anti-Diabetics-inputs.yml).

## Usage

Run: `cwltool Anti-Diabetics.cwl Anti-Diabetics-inputs.yml`
